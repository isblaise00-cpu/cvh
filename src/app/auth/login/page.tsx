    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 to-accent-600 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Connexion à CVH</h1>
          <p className="text-white/60 text-sm mt-1">Catalyseur de Valeur Humaine</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition text-sm font-medium"
            >
